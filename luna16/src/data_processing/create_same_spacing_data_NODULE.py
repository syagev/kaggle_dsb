...
def create_slices(imagePath, maskPath, cads):
    ...
    for z in sliceList:
        ...
        #save the lung slice
        savePath = re.sub(r"original_lungs", SAVE_FOLDER_image, imagePath)
        ...
        savePath = re.sub(r"original_lungs", SAVE_FOLDER_lung_mask, imagePath)
        ...
        savePath = re.sub(r"original_lungs", SAVE_FOLDER_nodule_mask, imagePath)
...
if __name__ == "__main__":
    ...
    for subset in range(10):
        ...
        #.replace('original_lungs/subset{}'.format(subset), 'original_lung_masks')
        #create_slices(imagePaths[0], imagePaths[0], cads)
        Parallel(n_jobs=6)(delayed(create_slices)(imagePath,imagePath, cads) for imagePath in imagePaths)
